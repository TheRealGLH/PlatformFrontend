...
<img id="lobbyMapPreview" :src="mapPreviewURL" @error="mapImageNotFound" :width="previewWidth" :height="previewHeight" :key="preview"/>
</transition>
<button>Start game</button>
</div>
  </div>
  <button @click="testMapSwitch">Test mapswitch</button>
  </div>
</template>
